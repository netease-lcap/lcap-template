...
export class PlaceholderFormatter extends Formatter {
  ...
  format(value, placeholder) {
    ...
    if (typeof value === "object" || Array.isArray(value)) return this.placeholder;
    else if (typeof value === "number" && isNaN(value)) return this.placeholder;
    else if (value === "" || value === undefined) return this.placeholder;
    else return value;
  }
