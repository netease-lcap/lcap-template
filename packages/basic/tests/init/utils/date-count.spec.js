...
describe('日期时间计数函数', () => {
  ...
  test('GetDateCount，Date 类型，无时区信息，兼容性测试', () => {
    ...
    expect(utils.GetDateCount('2023-09-21', 'day-week')).toBe(4);
  });
  ...
  test('GetSpecificDaysOfWeek，Date 类型，无时区信息，兼容性测试', () => {
    expect(utils.GetSpecificDaysOfWeek('2023-09-18', '2023-09-24', [1, 7, 8])).toEqual(['2023-09-18', '2023-09-24']);
  });
  ...
  test('GetSpecificDaysOfWeek，DateTime 类型，有时区信息', () => {
    ...
    expect(utils.GetSpecificDaysOfWeek(d1, d2, [1, 7, 8], 'Asia/Shanghai')).toEqual([
      '2023-09-18T00:00:00.000+08:00',
      '2023-09-24T00:00:00.000+08:00',
    ]); // 上海时间是 18 号到 24 号

    expect(utils.GetSpecificDaysOfWeek(d1, d2, [1, 7, 8], 'America/New_York')).toEqual([
      '2023-09-17T00:00:00.000+08:00',
      '2023-09-18T00:00:00.000+08:00',
    ]); // 纽约时间是 17 号到 23 号
  });
