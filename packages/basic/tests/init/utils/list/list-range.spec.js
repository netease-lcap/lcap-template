...
describe('List range functions', () => {
  test('List range step > 0', () => {
    ...
    {
      const expectArr = [];
      const testArr = utils.ListRange(-1, -10, 1);
      expect(JSON.stringify(expectArr)).toEqual(JSON.stringify(testArr));
    }
    {
      const expectArr = [];
      const testArr = utils.ListRange(1, 1, 1);
      expect(JSON.stringify(expectArr)).toEqual(JSON.stringify(testArr));
    }
  });
  test('List range step < 0', () => {
    {
      ...
      const testArr = utils.ListRange(10, 1, -2);
      expect(JSON.stringify(expectArr)).toEqual(JSON.stringify(testArr));
    }
    {
      const expectArr = [-1, -3, -5, -7, -9];
  ...
  test('List range step == 0', () => {
    {
      const expectArr = [];
      const testArr = utils.ListRange(1, 10, 0);
      expect(JSON.stringify(expectArr)).toEqual(JSON.stringify(testArr));
    }
  });
});
