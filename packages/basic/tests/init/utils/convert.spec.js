...
describe('Convert 函数', () => {
  ...
  test('Convert 函数，string 到 Integer', () => {
    expect(codewaveUtils.Convert('123.4', { typeKind: 'primitive', typeName: 'Long' })).toBe(123);
    expect(codewaveUtils.Convert('1234.5', { typeKind: 'primitive', typeName: 'Long' })).toBe(1235);
  });

  test('Convert 函数，string 到 Decimal', () => {
    expect(codewaveUtils.Convert('123.4', { typeKind: 'primitive', typeName: 'Decimal' })).toBe(123.4);
    expect(codewaveUtils.Convert('1.01', { typeKind: 'primitive', typeName: 'Decimal' })).toBe(1.01);
  });

  test('Convert 函数，时间戳 到 DateTime', () => {
    const t = '1699952685877';

    expect(codewaveUtils.Convert(t, { typeKind: 'primitive', typeName: 'DateTime' })).toBe(
      '2023-11-14T17:04:45.877+08:00',
    );
  });
