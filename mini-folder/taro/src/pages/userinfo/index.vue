  ...
  <view class="userinfo">
    <form @submit="handleSubmit">
      <view class="userinfo-room">
        <button class="userinfo-avatar" open-type="chooseAvatar" @chooseavatar="handleLaunch">
        ...
        <view class="userinfo-nickname">
          ...
          <input
            ...
            id="nickname-input"
            type="nickname"
            @nicknamereview="handleChangeNickName"
            placeholder-class="wechat-input-placeholder"
            class="wechat-input"
            placeholder="请输入昵称"
          />
        </view>
